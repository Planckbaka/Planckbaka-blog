...
import FeatureList from "@/components/ability-list";
  ...
  return (
          <div className="flex flex-col min-h-screen w-full h-full md:mt-20">
              ...
              <main className="flex flex-grow flex-col p-4">
                  <section id="home" className="flex flex-col max-w-5xl mx-auto md:py-24 pb-14">
                      <p className="text-md md:text-lg font-mono text text-muted-foreground">Hi I am Aki Wayne</p>
                      <div
                          ...
                          <p className="md:text-2xl font-mono text-muted-foreground">Transforming ideas into interactive and seamless digital experiences with cutting-edge frontend development.</p>
                      </div>
                      <ConnectIcons/>
                      <LogoLoopDemo/>
                      <FeatureList/>
              ...
              <footer className="flex py-4 items-center justify-between px-4">
                  <div
                      className="flex flex-row justify-center gap-1 text-center p-1 font-medium text-xs leading-loose sm:text-sm text-gray-500 w-full">
                      <p>Aki Wayne </p>
